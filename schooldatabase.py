...
def records():
    print('-------------------------------------------------------------')
    print('Do you have an argument by which you can search for a particular student?')
...
If you want to return to previous menu, press7.\n>')
    ...
    if len(docs)>1:
        print('There are multiple Entries inside the Database refering to that person\'s details')
        print('Consider Identifying the student from the data given above or using other parameters.\n\
If you find them, notice their ID and TYPE it in to obtain access OR type "db.reload" to use different parameter')
        ...
        if inp=='db.reload':
            ...
            try:
                ...
                dbs=doc
                print('-------------------------------------------------------------')
                print('Now that you have identified entry, you can begin editing it.')
                print('The column name will start display. Add the addition you want to make to respective entry against it\
and then press ENTER.\n*If you don\'t want to edit any specific entry, press 0')
        ...
        print('The column name will start display. Add the addition you want to make to respective entry\
...
def interface():
    ...
    print('Welcome to the Student Registry Database For New Admission Documentation')
